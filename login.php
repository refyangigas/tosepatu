                    ...
                    <div class="center-wrap">
                      ...
                      <div class="section text-center">
                        ...
                        <div class="form-group">
                          <input type="text" name="username" class="form-style" placeholder="Your Username" id="logemail" autocomplete="off" required>
                        ...
                        <p class="mb-0 mt-4 text-center"><a href="reset_password.php" class="link">Forgot your password?</a></p>
                      </div>
                    </div>
                  </form>
                </div>
                  ...
                  <div class="center-wrap">
                    <div class="section text-center">
                      ...
                      <form action="" method="post">
                        <div class="form-group">
                          <input type="text" name="regis-nama" class="form-style" placeholder="Your Full Name" id="logname" autocomplete="off" required>
                          <i class="input-icon uil uil-user"></i>
                        </div>
                        <div class="form-group mt-2">
                          <input type="text" name="regis-username" class="form-style" placeholder="Your Username" id="logemail" autocomplete="off" required>
                          <i class="input-icon uil uil-at"></i>
                        </div>
                        <div class="form-group mt-2">
                          <input type="password" name="regis-password" class="form-style" placeholder="Your Password" id="logpass" autocomplete="off" required>
                          <i class="input-icon uil uil-lock-alt"></i>
                        </div>
                        <button class="btn mt-4" name="register" type="submit">submit</button>
                      </form>
                    </div>
                  </div>
                </div>
