                                ...
                                <form action='login.php' method="POST" >
									<div class="center-wrap">
											...
											<div class="form-group">
												<input type="text" name="username" class="form-style" placeholder="Your Email" id="logemail" autocomplete="off">
                                            ...
                                            <button class="btn mt-4" name="submit" type="submit">submit</button>
...
if (isset($_POST['submit'])) {
  ...
  //query login
  $sql_login = "SELECT * FROM akun WHERE username='$username' AND password='$password'";
